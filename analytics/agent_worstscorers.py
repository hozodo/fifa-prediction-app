...
def agent(rows):
    ...
    headers = ["Rank", "Name", "Average Score"]
        ...
        "columns": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "type": "TextBlock",
                        "text": "🏆Congratulations to the **brave bottom finishers**🤣!",
                        "size": "Medium",
                        "wrap": True,
                        "spacing": "None"
                    }
    ...
    "items": [
        {
            "type": "TextBlock",
            "text": "**How was the score calculated?**",
            "weight": "Bolder",
            "wrap": True
        },
        {
            "type": "TextBlock",
            "text": (
                "The leaderboard only includes participants who submitted predictions for every match played during the previous week. "
                "Rankings are based on each participant's average score across those matches."
            ),
            "wrap": True,
            "spacing": "Small"
        }
