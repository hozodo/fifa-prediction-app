...
def agent(rows):
        ...
        "columns": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "type": "TextBlock",
                        "text": "🏆 Congratulations to this week's ranking climbers!🎉",
                        "size": "Medium",
                        "wrap": True,
                        "spacing": "None"
                    }
    ...
    "items": [
        ...
        },
        {
            "type": "TextBlock",
            "text": (
                "The leaderboard ranks participants based on how many positions they moved compared to the previous week, highlighting the predictors who made the biggest climbs up the rankings."
            ),
            "wrap": True,
            "spacing": "Small"
        }
